...
public class TicketService {
    ...
    public void count(List<OrderedSeats> reservedSeatsList,CinemaRoom cinemaRoom) {
        number_of_available_seats = cinemaRoom.getTotal_columns() * cinemaRoom.getTotal_rows();
        for (OrderedSeats orderedSeats : reservedSeatsList) {
            current_income += orderedSeats.getTicket().getPrice();
